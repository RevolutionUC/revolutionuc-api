...
export type EMAIL = 'confirmAttendance' | 'infoEmail1' | 'infoEmail2' | 'infoEmail3' | 'infoEmail4' | 'infoEmailMinors' | 'infoEmailJudges1' | 'infoEmailJudges2' | 'waiverUpdate' | 'latticeResetPassword';
